var scenePlay = new Phaser.Class({
    ...
    create: function () {
        ...
        var hitEnemy = function(player, enemy){
            ...
            //menghentikan musik background
            this.music_play.stop();
            
            //menghentikan sound efek berjalan
            this.snd_walk.setVolume(0);
            ...
            //animasi karakter terpental ke belakang saat terkena musuh
            this.tweens.add({
                targets: player,
                x: player.x - 100,
                y: player.y - 50,
            ...
            //animasi screen shake (guncangan layar)
            this.cameras.main.shake(500, 0.02);
            
            //delay sebelum menampilkan game over screen
            this.time.delayedCall(800, () => {
                //membuat lapisan gelap untuk background game over
                var gameOverBg = this.add.rectangle(X_POSITION.CENTER, Y_POSITION.CENTER,
                    game.canvas.width, game.canvas.height, 0x000000);
                gameOverBg.setDepth(15);
                gameOverBg.alpha = 0;
                
                //animasi fade in untuk background gelap
                this.tweens.add({
                    targets: gameOverBg,
                    alpha: 0.8,
                    duration: 500,
                ...
                //animasi muncul untuk gambar game over (bounce effect)
                this.tweens.add({
                    delay: 300,
                ...
                var finalScoreText = this.add.text(X_POSITION.CENTER, Y_POSITION.CENTER + 80, 
                    'Final Score: ' + this.countCoin, {
                    fontFamily: 'Verdana, Arial',
                    fontSize: '28px',
                    color: '#ffff00',
                    stroke: '#000000',
                ...
                //animasi fade in untuk teks skor
                this.tweens.add({
                    delay: 800,
                    targets: finalScoreText,
                    alpha: 1,
                    y: finalScoreText.y - 10,
                    duration: 400,
                    ease: 'Power2'
                });
                
                //menampilkan teks "Click to Restart"
                var restartText = this.add.text(X_POSITION.CENTER, Y_POSITION.CENTER + 130, 
                    'Click to Restart', {
                    fontFamily: 'Verdana, Arial',
                    fontSize: '20px',
                    color: '#ffffff',
                ...
                //animasi berkedip untuk teks restart
                this.tweens.add({
                    delay: 1200,
                    targets: restartText,
                    alpha: 1,
                ...
                //menambahkan input untuk restart game
                this.input.once('pointerdown', () => {
                    //memainkan sound efek touch
                    this.snd_touch.play();
                ...
                //menambahkan input keyboard untuk restart (tekan SPACE)
